...
void SparkleAnimationControl::on_thresholdSpinBox_valueChanged(int arg1) {
	maestro_control_->execute_cue(maestro_control_->animation_handler->set_sparkle_options(maestro_control_->get_section_index(), maestro_control_->get_layer_index(), arg1));
}
