...
namespace PixelMaestroStudio {
	...
	QString PreferencesDialog::device_port_num = QStringLiteral("PortNum");
	...
	PreferencesDialog::PreferencesDialog(QWidget *parent) : QDialog(parent), ui(new Ui::PreferencesDialog) {
		...
		ui->portNumSpinBox->setValue(settings_.value(device_port_num, 8077).toInt());
	}
	...
	void PreferencesDialog::on_buttonBox_accepted() {
		...
		settings_.setValue(device_port_num, ui->portNumSpinBox->value());
	}
